<script setup>
    ...
    function editItem(id) {
        axios.get('/Useremails/' + id).then(result => {
    ...
    function deleteItem(id) {
        swal_confirm().then(result => {
            if (result.value) {
                axios.delete("/Useremails/" + id).then(res => {
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                ...
                <UserEmailModal :item="dataItem" @onSaved="itemSaved" />
                <UserEmailViewModal :item="dataItem" />

                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">User Emails</h3>
                        <div class="ms-auto">
