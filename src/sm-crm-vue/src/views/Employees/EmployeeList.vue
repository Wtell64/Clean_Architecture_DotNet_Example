...
import EmployeeModal from '@/views/Employees/EmployeeModal.vue'
import EmployeeViewModal from '@/views/Employees/EmployeeViewModal.vue'
...
function editItem(id) {
    axios.get('/Employees/' + id).then(result => {
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                ...
                <EmployeeModal :item="dataItem" @onSaved="itemSaved" />
                <EmployeeViewModal :item="dataItem" />
