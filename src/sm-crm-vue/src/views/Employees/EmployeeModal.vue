...
const allStatusType = ref()
const allTerritory = ref()

onMounted(() => {
    axios.get('/Users').then(result => allUsers.value = result.data)
    axios.get('/Departments').then(result => allDepartment.value = result.data.data)
    axios.get('/StatusTypes').then(result => allStatusType.value = result.data.data)
    axios.get('/Territories').then(result => allTerritory.value = result.data)
})
            ...
            <div class="modal-content" v-if="item">
                <form @submit.prevent="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <select class="form-select">
                                    <option selected>{{ item.fullName }}</option>
                        ...
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Identity Number</label>
                            <div class="col-lg-9">
                                <input v-model="item.identityNumber" class="form-control" />
                            </div>
                        </div>
