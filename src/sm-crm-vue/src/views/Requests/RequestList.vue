<script setup>
    ...
    import RequestViewModal from '@/views/Requests/RequestViewModal.vue'
    ...
    function editItem(id) {
        axios.get('/Requests/' + id).then(result => {
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                ...
                <RequestModal :item="dataItem" @onSaved="itemSaved" />
                <RequestViewModal :item="dataItem" />
