<script setup>
    ...
    import DepartmentModal from '@/views/Departments/DepartmentModal.vue'
    import DepartmentViewModal from '@/views/Departments/DepartmentViewModal.vue'
    ...
    function editItem(id) {
        axios.get('/Departments/' + id).then(result => {
