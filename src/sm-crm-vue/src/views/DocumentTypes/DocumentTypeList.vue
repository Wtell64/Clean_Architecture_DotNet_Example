<script setup>
    ...
    import DocumentTypeModal from '@/views/DocumentTypes/DocumentTypeModal.vue'
    import DocumentTypeViewModal from '@/views/DocumentTypes/DocumentTypeViewModal.vue'
    ...
    function fetchItems(page = 1) {
        currentPage = page;
        axios.get('/DocumentTypes', { params: {
            pageNumber: page,
    ...
    function editItem(id) {
        axios.get('/DocumentTypes/' + id).then(result => {
    ...
    function deleteItem(id) {
        swal_confirm().then(result => {
            if (result.value) {
                axios.delete("/DocumentTypes/" + id).then(res => {
