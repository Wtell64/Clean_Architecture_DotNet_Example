<script setup>
    ...
    import SaleModal from '@/views/Sales/SaleModal.vue'
    import SaleViewModal from '@/views/Sales/SaleViewModal.vue'
    ...
    function editItem(id) {
        axios.get('/Sales/' + id).then(result => {
            result.data.saleDate = result.data.saleDate.substring(0, 10);
    ...
    function deleteItem(id) {
        swal_confirm().then(result => {
            if (result.value) {
                axios.delete("/Sales/" + id).then(res => {
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                ...
                <SaleModal :item="dataItem" @onSaved="itemSaved" />
                <SaleViewModal :item="dataItem" />
