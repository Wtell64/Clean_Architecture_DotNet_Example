...
import UserAddressModal from '@/views/UserAddresses/UserAddressModal.vue'
import UserAddressViewModal from '@/views/UserAddresses/UserAddressViewModal.vue'
...
function editItem(id) {
    axios.get('/UserAddreses/' + id).then(result => {
...
function deleteItem(id) {
    swal_confirm().then(result => {
        if (result.value) {
            axios.delete("/UserAddreses/" + id).then(res => {
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                ...
                <UserAddressViewModal :item="dataItem" />
                        ...
                        <div class="d-flex">
                            <div class="text-muted">
                                ...
                                <div class="mx-2 d-inline-block">
                                    <input type="text" class="form-control form-control-sm" v-model="tablePageSize" size="3"
                            ...
                            <div class="ms-auto text-muted">
                                ...
                                <div class="ms-2 d-inline-block">
                                    <input type="text" class="form-control form-control-sm" aria-label="Search"
                                        v-model="tableSearch" @keyup.enter="fetchItems(1)">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                ...
                                <tr v-for="item in dataList.items" v-if="dataList">
                                    ...
                                    <td>
                                        {{ item.country.length > 12 ? item.address.substring(0, 15) + '...' : item.country
                                        }}
                                    </td>

                                    <td>{{ item.city }}</td>
                                    <td>
                                        {{ item.address.length > 15 ? item.address.substring(0, 15) + '...' : item.address
                                        }}
                                    </td>
